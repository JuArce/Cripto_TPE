...
COMMON = ./src/algorithms/embed.o ./src/algorithms/extract.o ./src/algorithms/stego_algorithms.o ./src/cli_parser/cli_parser.o ./src/files/bmp.o ./src/files/file.o ./src/files/files.o ./src/logger/logger.o ./src/stego_cfg/stego_cfg.o
